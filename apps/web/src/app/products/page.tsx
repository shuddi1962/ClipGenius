      ...
      <Card className="bg-gradient-to-r from-roshanal-navy to-roshanal-blue text-white">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-roshanal-navy hover:bg-gray-100" >
              <a href="https://wa.me/2348109522432" target="_blank" rel="noopener noreferrer">
                <MessageCircle className="w-5 h-5 mr-2" />
                WhatsApp Us
              </a>
            </Button>
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-roshanal-navy" >
