          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                ...
                />
                <span className="text-sm text-nexus-text-primary">Remember me</span>
              </label>

              <Link
                href="/forgot-password"
                className="text-sm text-nexus-blue hover:text-nexus-accent transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-nexus-text-tertiary">Or continue with</span>
              </div>
            </div>
